...
class WebViewEnhancer {
  ...
  setupJavaScriptLinkHandling() {
      ...
      (e) => {
        if (
          ...
          if (this.debugMode) {
            ...
            console.log(
              "WebView High Priority: JavaScript link detected, executing immediately..."
            );
          ...
          try {
            ...
            if (this.debugMode) {
              console.log(
                "WebView High Priority: Executing JavaScript code:",
                jsCode
              );
            }
            ...
            if (this.debugMode) {
              console.log(
                "WebView High Priority: JavaScript executed successfully, result:",
                result
              );
            }
          } catch (error) {
            console.error(
              "WebView High Priority: Error executing JavaScript link:",
              error
            );
            console.error(
              "WebView High Priority: JavaScript code was:",
              jsCode
            );
          }
    ...
    document.addEventListener(
      ...
      (e) => {
        if (e.target.tagName === "A" && e.target.href) {
          ...
          if (e.target.href.startsWith("javascript:")) {
            ...
            try {
              ...
              try {
                ...
                if (this.debugMode) {
                  console.log(
                    "WebView: JavaScript executed successfully with eval.call"
                  );
                }
              } catch (evalError) {
                if (this.debugMode) {
                  console.log(
                    "WebView: eval.call failed, trying Function constructor"
                  );
                }
                ...
                if (this.debugMode) {
                  console.log(
                    "WebView: JavaScript executed successfully with Function constructor"
                  );
                }
              }
            } catch (error) {
          ...
          if (
            ...
            if (this.debugMode) {
              console.log(
                "WebView: Fragment link detected, allowing normal navigation"
              );
            }
          ...
          if (
            ...
            if (this.debugMode) {
              console.log(
                "WebView: External link detected, allowing normal navigation"
              );
            }
          ...
          if (this.debugMode) {
            console.log(
              "WebView: Regular link detected, allowing normal navigation"
            );
          }
      ...
      false
    ); // Use bubbling phase, lower priority
  }
            ...
            if (node.nodeType === 1) {
              ...
              videos.forEach((video) => {
                if (video.hasAttribute("disablepictureinpicture")) {
                  if (this.debugMode) {
                    console.log(
                      "WebView: Automatically removing disablepictureinpicture from:",
                      video
                    );
                  }
